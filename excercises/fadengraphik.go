...
var (
	...
	ThreadList = []ThreadData{
        {1.5, colornames.LemonChiffon},
		{2.5, colornames.DarkViolet.Bright(0.2)},
		{2.5, colornames.DarkBlue.Bright(0.1)},
		{2.5, colornames.DarkGreen},
		{2.5, colornames.DarkOliveGreen.Dark(0.1)},
		{2.5, colornames.DarkOrange.Dark(0.2)},
	}
)
