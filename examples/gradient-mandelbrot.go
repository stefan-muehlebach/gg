...
func main() {
	...
	grad4.AddColorStop(0.0, color.RGBAF{0.6595, 0.0, 0.0, 1.0})
	grad4.AddColorStop(0.18, color.RGBAF{0.0, 0.3058, 0.5877, 1.0})
	grad4.AddColorStop(0.39, color.RGBAF{0.8164, 0.4148, 0.0718, 1.0})
	grad4.AddColorStop(0.57, color.RGBAF{0.0, 0.4867, 0.1648, 1.0})
